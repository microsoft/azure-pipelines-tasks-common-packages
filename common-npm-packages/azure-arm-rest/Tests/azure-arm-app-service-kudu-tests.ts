...
export class KuduTests { 
    ...
    public static async updateDeployment() {
        ...
        try {
            var kudu = new Kudu('http://MOCK_SCM_WEBSITE', 'MOCK_SCM_BEARERTOKEN', true);
        ...
        try {
            var kudu = new Kudu('http://FAIL_MOCK_SCM_WEBSITE', 'MOCK_SCM_BEARERTOKEN', true);
            await kudu.updateDeployment({id: 'MOCK_DEPLOYMENT_ID', type: 'Deployment'});
    ...
    public static async zipDeploy() {
        try {
            let kudu = new Kudu('http://MOCK_SCM_WEBSITE', 'MOCK_SCM_BEARERTOKEN', true);
        ...
        try {
            let kudu = new Kudu('http://FAIL_MOCK_SCM_WEBSITE', 'MOCK_SCM_BEARERTOKEN', true);
            let deploymentDetails = await kudu.zipDeploy(path.join(__dirname, 'package.json'), ['deployer=VSTS_ZIP_DEPLOY']);
